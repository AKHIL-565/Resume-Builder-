...
const Signup = () => {
    ...
    return (
        <div className="relative min-h-screen bg-[#0f0f1a] text-white font-display overflow-x-hidden selection:bg-primary selection:text-midnight-indigo">
            ...
            <header className="relative z-20 flex items-center justify-between px-6 py-6 lg:px-20">
                <Link to="/" className="flex items-center gap-3 group">
                    <div className="p-2 bg-[#f4c025] transition-transform group-hover:scale-110">
                    ...
                    <div className="bg-[#1a1a2e] border-t-4 border-[#f4c025] p-10 md:p-12 shadow-2xl relative">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-[10px] text-[#f4c025] mt-1 font-bold uppercase tracking-tighter">Password must be at least 8 characters</p>
                            </div>

                            <div className="flex items-start gap-3 py-2">
                                <input className="mt-1 bg-indigo-900/30 border-slate-700 text-[#f4c025] focus:ring-[#f4c025] rounded-none cursor-pointer" type="checkbox" required />
                            ...
                            <button
                                type="submit"
                                className="w-full bg-[#f4c025] text-[#1a1a2e] py-4 text-lg font-black uppercase tracking-widest hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 group/btn"
                            >
                                Create Account
                        ...
                        <div className="mt-8 pt-8 border-t border-slate-800 flex flex-col gap-4">
                            ...
                            <p className="text-center text-sm text-slate-500">
                                Already have an account? <Link to="/login" className="text-white hover:text-[#f4c025] transition-colors font-bold underline underline-offset-4 decoration-[#f4c025]/30">Login</Link>
                            </p>
                        </div>
                    </div>
                </div>
